...
public class SavWav
{
    ...
    public static bool Save([NotNull] string filename, AudioClip clip)
    {
        ...
        try
        {
            ...
            ClipData clipData = new ClipData {samples = clip.samples, channels = clip.channels};
        ...
        {
            Debug.LogWarning(e);
            // return false if there's a failure saving the file
            return false;
        }
